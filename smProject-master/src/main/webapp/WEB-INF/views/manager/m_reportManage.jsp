						...
						<div class="resp-tabs-container hor_1">
							...
							<div>
								<div class="row">
									...
									<h2>1주차</h2>
									<div class="panel panel-default">
										<table class="table board" id="r_table4">
											<thead>
												<tr>
													<th style="padding-left: 4px;"><input type="checkbox"
														onclick="selectAllCheckBox(this,'r_table4','cb')"></th>
													<th>번호</th>
													<th>조</th>
													<th>스터디진도</th>
													<th>장소</th>
									...
									<div class="col-r">
										<a href="report.html" class="btn btn-primary btn-lg">다운로드</a>
									</div>
									<div class="fh5co-spacer fh5co-spacer-sm"></div>

									<h2>2주차</h2>
									<div class="panel panel-default">
										<table class="table board" id="r_table5">
											<thead>
												<tr>
													<th style="padding-left: 4px;"><input type="checkbox"
														onclick="selectAllCheckBox(this,'r_table5','cb')"></th>
													<th>번호</th>
													<th>조</th>
													<th>스터디진도</th>
													<th>장소</th>
									...
									<h2>3주차</h2>
									<div class="panel panel-default">
										<table class="table board" id="r_table6">
											<thead>
												<tr>
													<th style="padding-left: 4px;"><input type="checkbox"
														onclick="selectAllCheckBox(this,'r_table6','cb')"></th>
													<th>번호</th>
													<th>조</th>
													<th>스터디진도</th>
													<th>장소</th>
