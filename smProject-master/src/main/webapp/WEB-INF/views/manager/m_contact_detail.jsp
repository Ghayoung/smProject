			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-12 animate-box">
						<form method="post">
							<div class="col-md-12">
								<img src="${R}manager/getImage?id=${ mentor.apply_f_intro_fk }" alt="" class="fh5co-align-center img-responsive">
								<div class="fh5co-spacer fh5co-spacer-sm"></div>
								<div class="fh5co-spacer fh5co-spacer-sm"></div>
							</div>
							<div class="col-md-6">
						    ...
						    <div class="col-md-12">
								...
								<img src="${R}manager/getImage?id=${ mentor.apply_f_time_id }" alt="${R}${ mentor.t_path }"><br><br>
						    </div>
						    <div class="col-md-12">
								<label for="doc">증빙서류</label><br>
								<img src="${R}manager/getImage?id=${ mentor.apply_f_doc_fk }" alt="${R}${ mentor.d_path }">
						    </div>
