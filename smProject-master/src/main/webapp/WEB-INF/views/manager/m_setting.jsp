...
<div id="fh5co-main">
			...
			<div class="container">
				...
				<form:form method="post" modelAttribute="setting" name="form" onsubmit="return checkM_setting();">
							<!--모집 기간-->
							<div class="col-md-12">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<form:input placeholder="모임 횟수" id="study_count" type="text" path="study_count" class="form-control input-lg"/>
								</div>	
							</div>
                            <div class="col-md-6">
								<div class="form-group">
									<label for="study_day">멘토당 최소 멘티 인원</label>
									<form:input placeholder="최소 멘티" id="min_mentee" type="text" path="min_mentee" class="form-control input-lg" />
								</div>	
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label for="study_day">멘토당 최대 멘티 인원</label>
									<form:input placeholder="최대 멘티" id="max_mentee" type="text" path="max_mentee" class="form-control input-lg" />
								</div>	
							</div>
							<!--마감 요일-->
							<div class="col-md-12">
								<div class="form-group">
									...
									<form:select path="report_deadline" class="form-control" id="report_deadline">
