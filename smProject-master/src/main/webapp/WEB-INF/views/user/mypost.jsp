											...
											<div class="col-md-8 animate-box">
                        							<div class="panel panel-default card" data-url="${R}user/menteeapply_detail">
		                                              ...
		                                              <div class="card-body">
														...
														<p>소개: 소개멘트</p>
														<p>신청인원: 1/4</p>
		                                                <a href="#" class="btn btn-primary btn-sm " style="margin:auto;">수정</a>
		                                                <a href="#" class="btn btn-primary btn-sm " style="margin:auto;">삭제</a>
		                                              </div>
		                                            </div>
                        						</div>
										</div>
	                        				...
	                        				<div class="panel panel-default ">
	                        					<table class="table board" style="table-layout:fixed">
	                        						<thead>
                       								...
                       								<tbody>
                       									<c:forEach var="article" items="${ postBoard.articles }" varStatus="status">
                       										<tr>
                        										<td>${ status.count }</td>
                        									    ...
                        									    <td><a href="${R}user/board_edit?id=${article.id}&bd=${postBoard.id}" class="btn btn-primary btn-sm " style="margin:auto;">수정</a></td>
                        									    <td><a href="${R}user/board_delete?id=${article.id}&bd=${postBoard.id}" class="btn btn-primary btn-sm " style="margin:auto;">삭제</a></td>
                        									</tr>
                       									</c:forEach>
                       								</tbody>
	                        					</table>
